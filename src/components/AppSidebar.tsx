...
const navItems = [
  ...
  { title: 'New Project', url: '/app/new-project', icon: Plus, accent: true },
      ...
      <nav className="flex-1 mt-4 space-y-1 px-3">
        {navItems.map((item) => (
          <NavLink
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-colors hover:bg-accent ${item.accent ? 'bg-primary/10 text-primary font-medium' : 'text-muted-foreground'}`}
